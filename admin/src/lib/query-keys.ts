...
export const queryKeys = {
  ...
  analytics: {
    ...
    dashboard: (from: string, to: string) => [...queryKeys.analytics.all, "dashboard", from, to] as const,
    overview: (from: string, to: string) => [...queryKeys.analytics.all, "overview", from, to] as const,
    sales: (from: string, to: string) => [...queryKeys.analytics.all, "sales", from, to] as const,
    salesHeatmap: (from: string, to: string) => [...queryKeys.analytics.all, "salesHeatmap", from, to] as const,
    users: (from: string, to: string) => [...queryKeys.analytics.all, "users", from, to] as const,
    usersTopSpenders: (from: string, to: string) => [...queryKeys.analytics.all, "usersTopSpenders", from, to] as const,
    usersReturning: (from: string, to: string) => [...queryKeys.analytics.all, "usersReturning", from, to] as const,
    products: (from: string, to: string) => [...queryKeys.analytics.all, "products", from, to] as const,
    marketing: (from: string, to: string) => [...queryKeys.analytics.all, "marketing", from, to] as const,
    inventory: (from: string, to: string) => [...queryKeys.analytics.all, "inventory", from, to] as const,
    product: (id: string, from: string, to: string) => [...queryKeys.analytics.all, "product", id, from, to] as const,
    productTable: (params: ListParams) => [...queryKeys.analytics.all, "productTable", params] as const,
  ...
  pointTransactions: {
    ...
    lists: (params?: ListParams) => [...queryKeys.pointTransactions.all, "list", params ?? {}] as const,
    userBalance: (userId: string) => [...queryKeys.pointTransactions.all, "balance", userId] as const,
  },
  pointFaqs: {
