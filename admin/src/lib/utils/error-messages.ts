...
const ERROR_PATTERNS: [test: (msg: string) => boolean, translation: string][] = [
  ...
  [
    (m) => m.includes("foreign key") && m.includes("user"),
    "Холбогдох хэрэглэгч олдсонгүй.",
  ],
  [
    (m) => m.includes("foreign key") && m.includes("order"),
    "Холбогдох захиалга олдсонгүй.",
  ],
  [
  ...
  [
    (m) => m.includes("check constraint"),
    "Оруулсан утга зөвшөөрөгдсөн хязгаараас гарсан байна.",
  ],
  ...
  [
    ...
    "Серверийн дотоод алдаа гарлаа. Дахин оролдоно уу.",
  ],
