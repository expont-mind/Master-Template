...
interface ArticleImageUploadCardProps {
  imageUrl: string;
  setImageUrl: (url: string) => void;
  disabled?: boolean;
}

export function ArticleImageUploadCard({
  imageUrl,
  setImageUrl,
  disabled,
}: ArticleImageUploadCardProps) {
  ...
  return (
    <Card>
      <CardContent className="p-6 space-y-4">
        <h3 className="text-lg font-semibold">Нийтлэлийн зураг</h3>
