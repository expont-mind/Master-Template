-- ============================================================================
-- APPLY THIS MIGRATION TO FIX "Нэмэлт мэдээлэл" SAVING ISSUE
-- Run this in Supabase SQL Editor
-- ============================================================================

-- 1. Create product_details table if not exists
...
-- 6. Drop old save_product function (4 params)
DROP FUNCTION IF EXISTS public.save_product(jsonb, jsonb, jsonb, uuid[]);

-- 7. Create/replace save_product with p_details parameter
...
SELECT 'Migration applied successfully! Нэмэлт мэдээлэл is now enabled.' as message;
