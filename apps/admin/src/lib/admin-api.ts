...
import {
  buildPaginatedCountParams,
  buildPaginatedDataParams,
  parseTotalCountHeader,
} from "./_adminApiHelpers";
...
export const adminApi = {
  ...
  async select<T>(
    table: string,
    select: string,
    options?: Omit<AdminApiOptions, "select">,
  ): Promise<T[]> {
  ...
  async getAllPaginated<T>(
    ...
    const dataParams = buildPaginatedDataParams(options);
    const countParams = buildPaginatedCountParams(options);
    ...
    if (!isError(countData)) {
      totalCount = parseTotalCountHeader(countRes.headers);
    }
...
export const adminOrders = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("orders", options),

  getById: (id: string, options?: { select?: string }) => adminApi.getById("orders", id, options),
...
export const adminUsers = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("users", options),

  getById: (id: string) => adminApi.getById("users", id),
...
export const adminProducts = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("products", options),

  getById: (id: string, options?: { select?: string }) => adminApi.getById("products", id, options),

  insert: (data: { name: string; price: number; [key: string]: unknown }) =>
    adminApi.insert("products", data),

  update: (id: string, data: Record<string, unknown>) => adminApi.update("products", id, data),

  delete: (id: string) => adminApi.delete("products", id),
};

export const adminReviews = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("reviews", options),

  getById: (id: string, options?: { select?: string }) => adminApi.getById("reviews", id, options),
...
export const adminFaqs = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("faqs", options),
  ...
  update: (id: string, data: Record<string, unknown>) => adminApi.update("faqs", id, data),

  delete: (id: string) => adminApi.delete("faqs", id),
};

export const adminArticles = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("articles", options),

  getById: (id: string) => adminApi.getById("articles", id),

  insert: (data: { title: string; content?: string; slug?: string; status?: string }) =>
    adminApi.insert("articles", data),

  update: (id: string, data: Record<string, unknown>) => adminApi.update("articles", id, data),

  delete: (id: string) => adminApi.delete("articles", id),
};

export const adminCategories = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("categories", options),
...
export const adminBrands = {
  getAll: (options?: AdminApiOptions) => adminApi.getAll("brands", options),

  insert: (data: { name: string; logo_url?: string }) => adminApi.insert("brands", data),

  update: (id: string, data: { name?: string; logo_url?: string }) =>
    adminApi.update("brands", id, data),

  delete: (id: string) => adminApi.delete("brands", id),
};
