...
export function SortableBannerItem({ banner, onDelete, onToggleActive }: SortableBannerItemProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Image preview */}
        <div
          className="w-16 h-10 sm:w-24 sm:h-14 rounded border overflow-hidden shrink-0 relative"
        ...
        {/* Active toggle */}
        {/* eslint-disable-next-line jsx-a11y/no-static-element-interactions, jsx-a11y/click-events-have-key-events -- wrapper only stops propagation; Switch handles its own keyboard input */}
