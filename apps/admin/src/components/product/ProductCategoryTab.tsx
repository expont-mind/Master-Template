...
export function ProductCategoryTab({
  ...
  const firstSelectedRoot = flatList.find((c) => c.level === 1 && categoryIds.includes(c.id));
        ...
        <div className="border rounded-md overflow-hidden">
          ...
          {filteredList.length === 0 ? (
            ...
            filteredList.map((cat) => {
              ...
              const isFeatured = firstSelectedRoot && cat.id === firstSelectedRoot.id;
              const levelColor = LEVEL_COLORS[cat.level] ?? LEVEL_COLORS[3];
