      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => updateVariant(variant.id, "discountPrice", e.target.value)}
            placeholder="45000"
          />
        </div>
      </div>
          ...
          return (
            <div key={attrId} className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => updateVariantAttribute(variant.id, attrId, v)}
              >
                <SelectTrigger>
                  <SelectValue placeholder={`${attr.display_name} сонгох`} />
                </SelectTrigger>
                <SelectContent>
                  {attr.values.map((val) => (
