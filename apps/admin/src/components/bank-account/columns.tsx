...
import { ImageCell, BadgeCell, ActionsCell } from "@/components/ui/data-table";
  ...
  return [
    {
      ...
      header: "",
      size: 60,
      cell: ({ row }) => <ImageCell src={row.original.logo_url} alt={row.original.bank_name} />,
    },
    {
      accessorKey: "bank_name",
      header: "Банк",
      cell: ({ row }) => <span className="font-medium">{row.original.bank_name}</span>,
    },
    {
