...
import { DELIVERY_STATUS_LABELS, PAYMENT_STATUS_LABELS } from "@/constants";
...
export function OrderEditHeader({ order, deliveryStatus, paymentStatus }: OrderEditHeaderProps) {
