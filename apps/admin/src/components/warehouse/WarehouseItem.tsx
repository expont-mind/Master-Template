...
import { Edit, Trash2, MapPin, Phone, User, Star } from "lucide-react";
    ...
    <div className="flex items-center justify-between p-4 hover:bg-muted/50">
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          <Badge variant="secondary">{WAREHOUSE_TYPE_LABELS[warehouse.type]}</Badge>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="ghost" size="icon" onClick={onDelete} disabled={warehouse.is_default}>
