...
export function UserPointHistoryCard({ userId, userName }: UserPointHistoryCardProps) {
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="text-sm text-muted-foreground text-center py-8">Point гүйлгээ байхгүй</p>
          ) : (
            <div className="space-y-4">
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between">
                  <p className="text-sm text-muted-foreground">Нийт {totalCount} гүйлгээ</p>
