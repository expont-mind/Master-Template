const SIDEBAR_PLACEHOLDERS = ["s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8"] as const;
const PRODUCT_PLACEHOLDERS = ["p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9"] as const;
        ...
        <div className="flex gap-16">
          ...
          <div className="flex flex-col flex-1">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 py-2.5">
              {PRODUCT_PLACEHOLDERS.map((id) => (
                <div key={id} className="flex flex-col gap-2.5 w-full max-w-[254px]">
