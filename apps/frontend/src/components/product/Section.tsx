        ...
        {children ?? (
          <div className="relative">
            ...
            {canScrollLeft && (
              <button
                onClick={() => scroll("left")}
                className="hidden md:flex absolute -left-7 top-[170px] -translate-y-1/2 z-20 w-12 h-12 items-center justify-center bg-white/80 border-2 border-white/10 rounded-full backdrop-blur-[50px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] transition-all cursor-pointer opacity-0 group-hover:opacity-100 hover:bg-surface"
            ...
            {canScrollRight && (
              <button
                ...
                className="hidden md:flex absolute -right-7 top-[170px] -translate-y-1/2 z-20 w-12 h-12 items-center justify-center bg-white/80 border-2 border-white/10 rounded-full backdrop-blur-[50px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] transition-all cursor-pointer opacity-0 group-hover:opacity-100 hover:bg-surface"
            ...
            <div ref={scrollRef} className="flex gap-2 md:gap-4 overflow-x-auto scrollbar-hide">
