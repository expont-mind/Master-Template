...
export const BrandLogoSection = ({ brands, title, iconSrc }: BrandLogoSectionProps) => {
  ...
  return (
    <div className="w-full bg-white flex justify-center group">
      <div className="pt-10 md:pt-16 pb-10 flex flex-col gap-4 md:gap-7 max-w-[1064px] w-full bg-surface md:bg-white">
                ...
                <div className="w-[96px] h-[96px] md:w-[200px] md:h-[200px] rounded-full flex items-center justify-center bg-white border border-gray-200 hover:border-gray-300 transition-colors overflow-hidden">
                  {brand.logo_url ? (
                    <Image
                      ...
                      unoptimized={isAnimatedImageUrl(brand.logo_url)}
                    />
                  ) : (
