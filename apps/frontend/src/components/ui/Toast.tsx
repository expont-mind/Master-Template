    ...
    >
      <div className="flex items-center gap-1.5 bg-white rounded-[10px] border border-border shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-4 min-w-[320px] md:w-[356px]">
        <div className="flex-1 min-w-0">
          <p className="text-text-primary font-medium text-sm font-manrope whitespace-nowrap">
            {toast.title}
          </p>
          {toast.message && (
            <p className="text-text-secondary font-normal text-xs font-manrope leading-4 mt-0.5">
              {toast.message}
            </p>
          )}
        </div>
