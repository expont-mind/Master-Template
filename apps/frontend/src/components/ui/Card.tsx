  ...
  return (
    <div
      className={cn(
        ...
        hover && "cursor-pointer transition-shadow hover:shadow-md dark:hover:shadow-zinc-800/50",
...
export function CardHeader({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div className={cn("mb-4 border-b border-zinc-100 pb-4 dark:border-zinc-800", className)}>
      {children}
    </div>
  );
}
