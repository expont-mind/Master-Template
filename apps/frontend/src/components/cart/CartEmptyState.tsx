  ...
  return (
    <div className="w-full bg-white flex justify-center">
      <div className="flex flex-col items-center max-w-[1064px] w-full pb-[52px] px-4 xl:px-0">
        <p className="px-0.5 pb-2 pt-8 md:pt-[52px] text-text-primary font-bold text-xl md:text-[26px] leading-9 font-manrope w-full hidden md:block">
          Сагс
        </p>
        ...
        <div className="pt-[152px] md:pt-7 flex flex-col gap-8 md:gap-[88px] w-full">
          <div className="flex-col gap-4 hidden md:flex">
            <div className="flex items-center gap-1">
              <p className="text-text-primary font-black text-base font-manrope">0</p>
