    ...
    <div className="flex flex-col gap-4 md:gap-2">
      <div className="flex flex-col">
        <div className="flex items-center gap-1.5 px-px md:px-0.5 overflow-x-auto whitespace-nowrap scrollbar-hide">
          ...
          <Slash />
          <p className="text-slate-950 text-sm font-normal font-manrope">Түгээмэл асуулт</p>
        </div>

        <p className="px-0 md:px-0.5 pb-0 md:pb-1 text-text-primary font-bold md:font-semibold text-2xl md:text-xl font-manrope">
          Түгээмэл асуулт
        </p>
        <p className="text-text-secondary font-normal text-sm md:text-base font-manrope px-0 md:px-0.5 pb-0 md:pb-2">
