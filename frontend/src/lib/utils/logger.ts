 ...
 *
 * Keep tags machine-readable (`snake_case`) so log scrapers can
 * aggregate without regex gymnastics. Structured `context` lets
 * downstream systems index by field instead of parsing strings.
 *
 * Mirrors admin/src/lib/observability/log.ts.
 */
