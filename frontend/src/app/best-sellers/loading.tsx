  ...
  return (
    <div className="w-full bg-white flex justify-center min-h-screen">
      <div className="flex flex-col max-w-[1064px] w-full px-4 xl:px-0">
        {/* Title */}
        <p className="px-0.5 pb-2 pt-5 md:pt-9 text-[#020617] font-bold text-xl md:text-[26px] leading-9 font-manrope">
        ...
        <div className="flex flex-col gap-7 pt-7 pb-10">
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-hide">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-9 w-24 skeleton rounded-full shrink-0"
              />
            ))}
          </div>
