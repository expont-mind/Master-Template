...
export const OrdersContent = ({
  ...
  const filteredOrders = localOrders.filter((order) =>
    filterOrderByTab(order, activeTab),
  );
    ...
    return (
      <>
        ...
        <DeleteModal
          ...
          description={
            deleteError ?? "Та энэ захиалгыг устгахдаа итгэлтэй байна уу?"
          }
      ...
      <div className="flex flex-col gap-4 md:gap-2 px-0 md:px-4 pt-0 md:pt-2 pb-0 md:pb-1 ">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center py-0 md:py-0.5">
            ...
            <p className="text-[#020617] font-bold md:font-medium text-2xl md:text-lg font-manrope">
              Миний захиалгууд
            </p>
          </div>
        </div>
